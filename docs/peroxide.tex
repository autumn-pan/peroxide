...
\begin{document}
	...
	\begin{definition}{Reachability}
		For some turing machine $M$, a halting signature $H^n$ is considered reachable if and only if there exists some $H^m$ s.t. $\exists p \in \mathbb{N} where \mu^p(H^m)$, and $H^m$ is the starting configuration of $M$. More relevantly, $H^n$ is considered unreachable if this is not the case.
	\end{definition}
	...
	\begin{lemma} For all turing machines $M$, if all corresponding halting signatures $H^n$ are unreachable, then $M$ is nonhalting.
